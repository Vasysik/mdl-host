...
if load_keys() == {}: create_api_key("admin", ["create_key", "delete_key", "get_key", "get_keys", "yt_get_video", "yt_get_audio", "yt_get_live_video", "yt_get_live_audio", "yt_get_info", "sp_get_track", "sp_get_info"])
